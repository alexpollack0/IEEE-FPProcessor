...
HD_PWD='/home/npalmer/ENEE359F/IEEE-FPProcessor/FinalProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FPProcessor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FPProcessor.tcl -notrace
